...
public class Mail2 {
	...
	private static final String myEmailAccount = "946977590@qq.com";
	private static final String myEmailPassword = "ghrogqnophskbdje";
	...
	public static String sendEmail(String receiveMailAccount, String username) throws Exception {
		...
		message.setContent(username + "<H1>用户你好,云栖系统激活邮件！点击以下链接进行账户激活</H1> <h3><a href='http:// 192.168.233.1:8080/xnjcpt/user/user_activate?verifyCode="+verifyCode+"'>http:// 192.168.233.1:8080/xnjcpt/user/user_activate?code="+verifyCode+"</a></h3>", "text/html;charset=UTF-8");
