...
<div class="login">
	...
	<div class="login-top">
		<h1>Register</h1>
		<form action="reset2" id="form1" method="post" onsubmit="return validate(this)">
			<input type="text" name="username" placeholder="请输入账户名">
			<h3><a href="${pageContext.request.contextPath }/fasong">发送验证码</a></h3><p>
