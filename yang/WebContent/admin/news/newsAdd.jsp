...
<blockquote class="layui-elem-quote news_search">
	...
	<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/addNews"	method="post">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<textarea placeholder="请输入内容" name="contentAbstract" class="layui-textarea"></textarea>
			</div>
		</div>
